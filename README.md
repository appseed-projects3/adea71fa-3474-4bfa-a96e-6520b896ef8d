...
> 🚀 Built with [Soft UI Dashboard Generator](https://appseed.us/generator/soft-ui-dashboard/), timestamp `2022-08-02 17:03`
...
```bash
$ # Get the code
$ git clone https://github.com/appseed-projects/adea71fa-3474-4bfa-a96e-6520b896ef8d.git
$ cd adea71fa-3474-4bfa-a96e-6520b896ef8d
```
